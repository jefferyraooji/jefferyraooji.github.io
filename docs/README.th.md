...
เริ่มต้นโปรเจ็กต์ในเครื่องโดยใช้ [create-jeffery](https://github.com/jefferyraooji/create-jeffery)
...
1. [Generate repository ใหม่](https://github.com/jefferyraooji/jefferyraooji.github.io/generate)ขึ้นมาจากแม่แบบนี้ หรือจะ fork repository นี้ก็ได้
